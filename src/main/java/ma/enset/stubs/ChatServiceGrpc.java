...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Chat.Message,
      ma.enset.stubs.Chat.Message> getFullStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Chat.Message,
      ma.enset.stubs.Chat.Message> getFullStreamMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Chat.Message, ma.enset.stubs.Chat.Message> getFullStreamMethod;
    if ((getFullStreamMethod = ChatServiceGrpc.getFullStreamMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getFullStreamMethod = ChatServiceGrpc.getFullStreamMethod) == null) {
          ChatServiceGrpc.getFullStreamMethod = getFullStreamMethod = 
              io.grpc.MethodDescriptor.<ma.enset.stubs.Chat.Message, ma.enset.stubs.Chat.Message>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "ChatService", "fullStream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Chat.Message.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Chat.Message.getDefaultInstance()))
                  .setSchemaDescriptor(new ChatServiceMethodDescriptorSupplier("fullStream"))
                  .build();
          }
        }
     }
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.enset.stubs.Chat.Message> fullStream(
  ...
  private static final int METHODID_FULL_STREAM = 0;
